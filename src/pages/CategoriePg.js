...
import CategoriePgDiv from "./CategoriePgDiv";
                  ...
                  >
                    {Categorie_1[index]?.clild?.length > 0
                      ? Categorie_1[index]?.clild.map((e, ids) => {
                          ...
                          return (
                            <div key={ids}>
                              <CategoriePgDiv  e={e}  ids={index} CategorieOne={CategorieOne} Categoriedlt={Categoriedlt} idsed={ids} />

                                    {
                            Categorie_1[index]?.clild[0]?.clild?.length > 0 ?
                             Categorie_1[index]?.clild[ids-1]?.clild.map((e, cids)=>{
                              console.log("cids",cids);
                              cids++
                              return(
                                <div>
                                  <div key={cids}>
                              <CategoriePgDiv  e={e}  ids={ids} CategorieOne={CategorieOne} Categoriedlt={Categoriedlt} idsed={cids} />
