export default function validate(values, hedaldata, SurveyData) {
    ...
    } else if (SurveyData.user_error) {
      if (SurveyData?.user_error?.data?.statusCode === "400") {
        errors.email = SurveyData?.user_error?.data?.message;
